...
![image](https://github.com/BossK73/Mini-WinPs-Sudo/blob/main/Pictures4Readme/Picture_RunSudoH.png)
...
[V0.0.5](https://github.com/BossK73/Mini-WinPs-Sudo/releases/tag/V0.0.5) Use a centralized hash table to store and initialize state and data cache, reduce conditional judgment overhead, remove unused arrays.
